...
# Safe-merge threshold per normalization spec — 90 instead of the older 80.
...
async def match_or_create_employee(
    ...
    if name_raw:
        ...
        if name_norm:
            ...
            # Ambiguous OR below threshold → create a NEW employee record so
            # accounting still proceeds, then enqueue for human review.
